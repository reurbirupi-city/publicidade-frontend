  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 relative">
          <div className={`text-center mb-20 transition-all duration-1500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="relative inline-block mb-8 group">
              ...
              <button
                onClick={handleLogin}
                className="relative inline-flex items-center gap-2 bg-gradient-to-r from-purple-600/90 via-pink-600/90 to-blue-600/90 backdrop-blur-xl border border-white/20 px-6 py-3 rounded-full hover:from-purple-500 hover:via-pink-500 hover:to-blue-500 transform hover:scale-105 transition-all duration-300 cursor-pointer shadow-2xl group"
              >
                <div className="flex items-center gap-2">
                  <Rocket className="w-4 h-4 text-white animate-pulse group-hover:animate-bounce" />
                  <span className="text-sm font-bold text-white tracking-wider">ACESSAR PLATAFORMA</span>
                  <Star className="w-3 h-3 text-yellow-300 animate-spin" style={{ animationDuration: '3s' }} />
                </div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight">
              <span className="block bg-gradient-to-r from-purple-300 via-pink-300 to-blue-300 bg-clip-text text-transparent mb-2 drop-shadow-2xl animate-pulse">
                Plataforma
              </span>
          ...
          <div className={`transition-all duration-1500 ${isLoaded ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '600ms' }}>
            <div className="relative max-w-6xl mx-auto">
              ...
              <div className="relative bg-gray-800/30 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                <div className="flex items-center justify-center gap-3 mb-6">
                  ...
                  <Gem className="w-6 h-6 text-cyan-400 animate-bounce" />
                </div>
                
                <p className="text-gray-200 text-base mb-8 text-center leading-relaxed max-w-3xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="group relative">
                    ...
                    <div className="relative bg-gray-900/50 backdrop-blur-xl border border-purple-400/20 rounded-2xl p-5 transform group-hover:scale-105 group-hover:-translate-y-2 transition-all duration-300">
                      <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl mb-3 group-hover:rotate-12 transition-transform">
                        <Users className="w-6 h-6 text-white" />
                      </div>
                      <h4 className="font-bold text-lg text-white mb-2 group-hover:text-purple-300 transition-colors">Gestão Inteligente</h4>
                  ...
                  <div className="group relative">
                    ...
                    <div className="relative bg-gray-900/50 backdrop-blur-xl border border-blue-400/20 rounded-2xl p-5 transform group-hover:scale-105 group-hover:-translate-y-2 transition-all duration-300">
                      <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl mb-3 group-hover:rotate-12 transition-transform">
                        <BarChart3 className="w-6 h-6 text-white" />
                      </div>
                      <h4 className="font-bold text-lg text-white mb-2 group-hover:text-blue-300 transition-colors">Analytics Premium</h4>
                  ...
                  <div className="group relative">
                    ...
                    <div className="relative bg-gray-900/50 backdrop-blur-xl border border-pink-400/20 rounded-2xl p-5 transform group-hover:scale-105 group-hover:-translate-y-2 transition-all duration-300">
                      <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-pink-500 to-pink-600 rounded-xl mb-3 group-hover:rotate-12 transition-transform">
                        <Palette className="w-6 h-6 text-white" />
                      </div>
                      <h4 className="font-bold text-lg text-white mb-2 group-hover:text-pink-300 transition-colors">Social Media Pro</h4>
        ...
        {/* Footer Elegante */}
        <footer className="relative border-t border-gradient-to-r from-purple-500/30 via-pink-500/20 to-blue-500/30 py-8 mt-12">

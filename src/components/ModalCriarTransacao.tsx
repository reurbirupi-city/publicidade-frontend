...
const ModalCriarTransacao: React.FC<ModalCriarTransacaoProps> = ({ isOpen, onClose, onSave }) => {
  ...
  useEffect(() => {
    if (tipo === 'receita') setCategoria('projeto');
    else setCategoria('equipe');
  }, [tipo]);
  ...
  const getErrosPorPasso = () => {
    ...
    if (tipo === 'receita' && !clienteId) erros2.push('Cliente é obrigatório para receitas');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const novaTransacao: Transacao = {
      id: `${tipo === 'receita' ? 'REC' : 'DESP'}-${Date.now().toString().slice(-6)}`,
      tipo,
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden border border-gray-200 dark:border-gray-800">
        <div
          className={`p-6 border-b border-gray-200 dark:border-gray-800 bg-gradient-to-r ${
            tipo === 'receita' ? 'from-green-500 to-emerald-500' : 'from-red-500 to-orange-500'
          }`}
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">Nova {tipo === 'receita' ? 'Receita' : 'Despesa'}</h2>
            </div>
            ...
            <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-red-900 dark:text-red-200 mb-1">Corrija os seguintes erros:</p>
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={tipo === 'receita' ? 'Ex: Projeto Website Cliente X' : 'Ex: Pagamento freelancer designer'}
                  />
                </div>
              ...
              <>
                ...
                <div className="flex items-center gap-3 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                  ...
                  <label htmlFor="recorrente" className="flex-1 cursor-pointer">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Esta {tipo} se repete mensalmente</p>
                  </label>
                </div>
              </>
            )}
        ...
        <div className="p-6 border-t border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/50 flex items-center justify-between gap-3">
          ...
          <div className="flex items-center justify-end gap-3">
            ...
            {step < steps.length - 1 ? (
              ...
              <button
                type="submit"
                form="form-criar-transacao"
                className={`px-6 py-3 rounded-lg text-white font-semibold transition-all hover:scale-105 shadow-lg ${
                  tipo === 'receita'
...
export default ModalCriarTransacao;
